...
export const ManicurePrices = () => {
    ...
    return (
        <ul className="service_prices">
            <li className="service_prices_unit manicure_basic">
            ...
            <li className="service_prices_unit manicure_design">
            ...
            <li className="service_prices_unit manicure_extension">
            ...
            <li className="service_prices_unit manicure_additional">
